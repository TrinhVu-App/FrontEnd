import { Text, View, TextInput, Button, Alert, Pressable, Image, ScrollView, KeyboardAvoidingView } from "react-native"
  ...
  onAddingStory = (data) => {
    ...
    axios
      ...
      .catch(e =>  {
        ...
        Alert.alert("Create Story Status", "Create Story Failed")
      })
  }
